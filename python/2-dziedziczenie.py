...
"""
Ponieważ różne rasy psów wydają nieco inne odgłosy, można podać domyślną wartość dla argumentu dźwiękowego odpowiednich metod .speak (). 
...
# Klasa dziedzicząca po klasie Dog
...
Ale zamiast jawnie definiować łańcuch wyjściowy, musisz wywołać .speak () klasy Dog wewnątrz .speak () klasy potomnej, 
